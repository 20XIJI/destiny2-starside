...
- {act|新增}[配色总览](../palette/index.html)：全站 14 支渲染色与 30 个着色类
- {act|改动}首页：技能、碎片、星相、异域装备与神器模组按所属元素着色，共 1168 处
- {act|改动}首页：神器模组名改用游戏内神器页面的青绿
- {act|改动}首页：注解统一成一个叫法、一种颜色，改用浅玫瑰粉
- {act|改动}首页：行标题里的武器类别、空格占位与强弱箭头不再跟注解同色
