...
| 回旋喝彩 | {ico|![](icons/86d9823bc4.webp)} | 高难：T1.5\\输出：T3 |  | 4403 | {champ|![](icons/a9911a3dfe.webp)} | 可以把他看作{el-strand|缚丝}但是需要蓄力的{exotic|寄生虫}，弹药经济优秀，反屏障 | 现在没有特别强的{el-strand|缚丝}或火属性绿弹补输出武器，而且{exotic|回旋喝彩}作为有{el-strand|缚丝}和{el-solar|烈日}两种属性的枪只适合血红衣吃满激涌 |  |
