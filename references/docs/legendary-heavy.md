...
**类型评级 T2。**除了总伤比翻新 A499 略高，DPS 差了相当多，但因为{art-perk|动能合成}的存在直接消除了总伤差距，可以说是翻新的全方面下位。或许只有在队伍中几乎无法施加易伤手段、{perk|聚合充能}叠层并不理想并且是长轴时才适合上场（粒子解构），单人 solo 地牢的情况也可以使用。粒子解构是施加在{enemy|战斗人员}身上的易伤，不与其他易伤叠加
