...
描述：扭曲星球每小时轮换，七个目的地循环。横排星期、竖排时段，168 格一屏查完。
更新：2026.8.6
页脚：轮换周期 7 小时，一周 168 小时正好走完 24 轮，因此每周的表相同。
此刻：是

## 每周轮换

扭曲每小时换一个目的地，一周 168 个时段的顺序固定如下。表内当前时段一整行、今天一整列跟随本机时钟高亮，两条的交点即此刻所在，整点自动跳到下一格。
